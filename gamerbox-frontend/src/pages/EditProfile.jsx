...
const EditProfile = () => {
  ...
  const [instagramProfile, setInstagramProfile] = useState(
    (user?.instagram_profile || "").replace("@", "")
  );
  const [twitterProfile, setTwitterProfile] = useState(
    (user?.twitter_profile || "").replace("@", "")
  );
  ...
  const handleRemoveSuperFavorite = async (gameId) => {
    try {
      ...
      setSuperFavoriteGames(
        superFavoriteGames.filter((game) => game.rawgId !== gameId)
      );
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setInstagramProfile(e.target.value.replace("@", ""))
                  }
                  placeholder="usuario"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTwitterProfile(e.target.value.replace("@", ""))
                  }
                  placeholder="usuario"
                  className="appearance-none block w-full pl-8 px-3 py-2 border border-[#2C2C2C] rounded-md shadow-sm 
                    placeholder-[#A0A0A0] bg-[#1E1E1E] text-[#E0E0E0]
